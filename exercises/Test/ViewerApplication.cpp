...
void ViewerApplication::InitializeModel()
{
	...
	// Load model
	m_model = loader.Load("models/campfire/campfire.obj");
	...
	m_model.GetMaterial(0).SetUniformValue("ColorTexture", textureLoader.LoadShared("models/campfire/campfire-stream.jpg"));
	m_model.GetMaterial(1).SetUniformValue("ColorTexture", textureLoader.LoadShared("models/campfire/campfire-stream1.jpg"));
	m_model.GetMaterial(2).SetUniformValue("ColorTexture", textureLoader.LoadShared("models/campfire/campfire-stream2.jpg"));
}
